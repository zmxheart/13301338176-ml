...
public class SimpleGridAgentSARSA extends Agent {
     ...
     * parameter.  
     */
    public SimpleGridAgentSARSA(double epsilon, double alpha, double gamma, 
				double lambda){
	...
	if (!state.isTerminal())
	    error += gamma * qEst[state.y][state.x][action.dir];
